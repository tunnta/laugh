# コンセプト
シンプルで直感的な操作を促すデザインの大喜利アプリです
# 目的
大喜利を通したコミュニケーションを誰もが楽しめるように画面サイズに合わせたレイアウト、直感的な使用感を重視しました。
# URL
...
お題の投稿、お題に対する回答の投稿  
回答への'いいね'機能  
3日経過したお題をお題に付随する、各回答のいいねの数を集計、ソートし、top画面の下方に移動し表示。(現在herokuスケジューラーを一時停止中) 
ランキング。  
