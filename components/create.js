...
function CreateTitle(props) {
    ...
    const lookImage={'position':'absolute',margin:'10% 5% 0% 5%',textAlign:"center",'whiteSpace':'preLine',"fontSize":select+"%"}
            ...
            <Grid align='center'>
              <FormControl style = {selectStyle}>
                  ...
                  <Select
                    ...
                    defaultValue = {200}
                  >
                      <MenuItem value={180}>大</MenuItem>
                      <MenuItem value={140}>中</MenuItem>
