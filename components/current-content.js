...
const backgraoundStyle = {'position':'relative', padding:20,transform: 'translateX(-50%)','-webkit-transform': 'translateX(-50%)','-ms-transform': 'translateX(-50%)',height:'112vh',width:920,textAlign:"center"}
