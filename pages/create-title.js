...
export default function userpage() {
  ...
  const [select, setSelect] = useState('200')
    ...
    const lookImage={'position':'absolute',margin:'10% 10% 0% 10%',textAlign:"center",wordBreak:"break-all","font-size":select+"%"}
    ...
    const titlePost=()=>{fetch('http://localhost:3001/title', {
        method: 'POST',
        headers: {
